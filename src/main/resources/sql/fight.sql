...
-- ----------------------------
INSERT INTO `permission` VALUES ('1', '用户中心', '1', null, 'page/user/userList.html', '0', '0');
...
CREATE TABLE `sys_logs` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=961 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
