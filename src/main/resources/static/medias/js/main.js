...
function getLangDate(){
    ...
    var userName  = window.sessionStorage.getItem("userName"); //登录的  用户名
    newDate = dateFilter(year)+"年"+dateFilter(month)+"月"+dateFilter(date)+"日 "+" "+dateFilter(hour)+":"+dateFilter(minute)+":"+dateFilter(second);
    document.getElementById("nowTime").innerHTML = "亲爱的 "+userName+","+timeValue+"好！ 欢迎使用设备管理系统1.0 ___当前时间为： "+newDate+"　"+week;
